...
describe('testing local auth functions in firebase.js', () => {
  describe('changePassword', () => {
    ...
    it('should throw error if weak password', async () => {
      firebase.updatePassword = jest
        .fn()
        .mockRejectedValue(new Error(firebase.AuthErrorCodes.WEAK_PASSWORD));
      expect(async () => await changePassword('MockPassword')).rejects.toThrow(
    ...
    describe('thirdPartySignIn', () => {
      it('should return signInWithPopup user output if sign in was successful', async () => {
        firebase.signInWithPopup = jest.fn(async () =>
          Promise.resolve({
            user: {
      ...
      it('should throw error if issue occurred while signing in with popup', async () => {
        ...
        expect(
          async () => await firebase.signInWithPopup('MockProvider')
  ...
  describe('resetPasswordEmail', () => {
    ...
    it('should throw error if sending email unsuccessful', async () => {
      firebase.sendPasswordResetEmail = jest
        .fn()
  ...
  describe('testing email/pass registration', () => {
    test('Empty Name', () => {
      expect(
        async () =>
          await registerWithEmailAndPassword('', 'test', 'test', 'test')
    ...
    test('Invalid Email', () => {
      expect(
        async () =>
          await registerWithEmailAndPassword('test', 'test', 'test', 'test')
    ...
    test('Weak Password', () => {
      firebase.createUserWithEmailAndPassword = jest
        .fn()
        .mockRejectedValue(new Error(firebase.AuthErrorCodes.WEAK_PASSWORD));
      expect(
        async () =>
    ...
    test('Email Exists', () => {
      firebase.createUserWithEmailAndPassword = jest
        .fn()
        .mockRejectedValue(new Error(firebase.AuthErrorCodes.EMAIL_EXISTS));
      expect(
        async () =>
          await registerWithEmailAndPassword(
            'test',
    ...
    test('Invalid Email - Firebase Side', () => {
      firebase.createUserWithEmailAndPassword = jest
        .fn()
        .mockRejectedValue(new Error(firebase.AuthErrorCodes.INVALID_EMAIL));
      expect(
        async () =>
          await registerWithEmailAndPassword(
            'test',
    ...
    test('Returns user successfuly', async () => {
      ...
      const val = await registerWithEmailAndPassword(
        'test',
        'test@gmail.com',
        'test',
        'test'
  ...
  describe('testing email/pass login', () => {
    test('Empty Email', () => {
      expect(
        async () => await logInWithEmailAndPassword('', '')
      ).rejects.toThrow('Please fill in all fields!');
    });
    test('Empty Password', () => {
      expect(
        async () => await logInWithEmailAndPassword('test', '')
      ).rejects.toThrow('Please fill in all fields!');
    });
    test('Returns user successfuly', async () => {
      const mockedReturn = { user: { uid: 'test' } };
    ...
    test('Invalid Credentials', () => {
      firebase.signInWithEmailAndPassword = jest
        .fn()
        .mockRejectedValue(
          new Error('The email and/or password you entered is incorrect!')
        );
      expect(
        async () => await logInWithEmailAndPassword('test@gmail.com', 'test')
      ).rejects.toThrow('The email and/or password you entered is incorrect!');
    });
  });
  ...
  describe('Google Sign In', () => {
    test('Returns user successfuly', async () => {
      const mockedReturn = {
        user: { displayName: 'test', email: 'test', uid: 'test' },
      };
    ...
    test('Email Exists', () => {
      firebase.signInWithPopup = jest
        .fn()
        .mockRejectedValue(
          new Error(firebase.AuthErrorCodes.NEED_CONFIRMATION)
        );
      expect(async () => await signInWithGoogle()).rejects.toThrow(
        'This email is in use through a different service!'
      );
    });
  });
  ...
  describe('Github Sign In', () => {
    ...
    test('Email Exists', () => {
      ...
      expect(async () => await signInWithGithub()).rejects.toThrow(
        'This email is in use through a different service!'
      );
    });
  });
