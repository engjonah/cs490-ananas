...
describe("Log In Page",()=>{
    ...
    describe('Email Password submission',()=>{
        test('Error Handling',async () =>{
            ...
            const {getByText} = render(<router.BrowserRouter><SignInPage/></router.BrowserRouter>)
    ...
    describe('Google Sign-in Submission',()=>{
        test('Error Handling',async () =>{
            ...
            const {getByTitle} = render(<router.BrowserRouter><SignInPage/></router.BrowserRouter>)
