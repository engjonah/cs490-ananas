  ...
  return (
    <div className="documentation-container">
      ...
      <div className="content">
        ...
        <p>Developers use the MERN stack for its flexibility, efficiency, and ease of learning. It enables rapid development of scalable and maintainable web applications.
      ...
      <div className="content">
        <h2>MERN</h2>
        <p>This documentation page provides basic information about the MERN (MongoDB, Express.js, React.js, Node.js) stack.
          The MERN stack is a popular web development stack used for building full-stack web applications.
          It consists of four main components:
        </p>
        <ul>
