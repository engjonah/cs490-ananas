  ...
  return (
    <Grid>
      ...
      <Card variant="outlined" className="help-container">
        ...
        >
          <p>
            ...
            or watch the walkthrough below for instructions on how to use this
            site!
          </p>
          <Card class="video-container">
            <img
              className="video-frame"
              src="https://awlights.com/wp-content/uploads/sites/31/2017/05/video-placeholder.png"
              alt="Video Thumbnail"
            />
          </Card>
        </Card>
      ...
      <Card variant="outlined" className="content">
        ...
        <h3>MERN</h3>
        <p>This web application was created with the MERN Stack:</p>
        <ul>
          <li>
            <strong>MongoDB:</strong> A NoSQL database used for storing
            application data.
          </li>
          <li>
        ...
        <h3>Translation</h3>
        <p>
          Code Translation is done through OpenAI API utilizing the{' '}
          <a href="https://platform.openai.com/docs/models/gpt-3-5-turbo">
            <b>GPT-3.5 Turbo Model</b>
          </a>
          .
        </p>
        ...
        <p>
          Authentication is handled through <b>Firebase API</b>. This includes
          user login and account creation as well as Two Factor Authentication.
        </p>
      </Card>
      <Card variant="outlined" className="content" sx={{ mb: '5vh' }}>
        ...
        <ul>
          <li>
            <strong>User Details:</strong> We store emails and usernames.
            Passwords are handled through Firebase
          </li>
          <li>
            <strong>Translation History:</strong> We store the translation
            history to make improvements to our translation tool. Users are able
            to view and delete past translations in the translation history
            section.{' '}
          </li>
        </ul>
      </Card>
