...
function FAQ() {
  ...
  const faqData = [
    ...
    { question: 'How can I setup two factor authentication?', answer: 'You can setup two factor authentication by following the instructions on this guide: <a href=Ananas2FAGuide>2FA Guide</a>.' },
